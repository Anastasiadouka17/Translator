...
def convert_digit(c):
    ...
    while (is_digit(c)):
        return decade_pattern(int(c)-1)+'\n..'# c has to be converted into an int so that it can be taken as a variable from function decade_pattern(decade_position)
    return None
